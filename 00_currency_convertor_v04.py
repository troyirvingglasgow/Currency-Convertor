...
class HelpWindow(tk.Toplevel):
    def __init__(self, master=None, parent=None):
        ...
        self.help_text = ("Welcome to the Currency Converter!\n\n"
                          ...
                          "Additional Features:\n\n"
                          "1. To view the history of all conversions, click the 'History' button. "
                          "This will open a new window displaying all previous conversions.\n"
                          "2. In the history window, select one or more entries by clicking on them. "
                          "Then, click the 'Export to File' button to save the selected entries to a text file named 'conversion_history.txt'.\n"
...
class HistoryExport:
    def __init__(self, parent, history):
        ...
        self.history_window.configure(bg="#bc6c25")

        # Previous conversions label
        previous_conversions_label = tk.Label(self.history_window, text="Previous Conversions", bg="#bc6c25", fg="#fefae0",
                                              font=("Arial", 12, "bold"))
        previous_conversions_label.pack(pady=(10, 5))

        # Create a Listbox to display history entries
        self.history_listbox = tk.Listbox(self.history_window, selectmode=tk.MULTIPLE, font=("Arial", 10), bg="#fefae0")
...
class CurrencyConverterApp:
    ...
    def convert_currency(self):
        ...
        if not amount:
            ...
            self.amount_entry.config(bg="#e65f5c")
            return
